<?php include("include/header.inc"); ?>
      ...
      knew which side of our bread was buttered, we were building this web site with NT... back
      ...
      I boot it to run exactly one program - an old, proprietary personal finance application. 
      It's the only thing I have ever found useful on Windows. Occasionally I look around for 
      ...
      I just got at Freshmeat when I entered "accounting" as my search term. I got geek soup: 
      ...
      personal and small business finance package - was not quite ready for prime time. 
      Inspired by meeting the developers at the Linux Business Expo, LWN took another 
